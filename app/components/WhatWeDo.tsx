            ...
            <section className="flex gap-5 items-center mt-20">
                {info.map((item, index) => (
                  ...
                  >
                        ...
                        <Link 
                            href='/work'
                            className="flex items-center w-[167px] gap-2 hover:gap-5 mt-6 px-4 py-2 bg-[#00a2af] text-white font-semibold text-md rounded-lg shadow-md transition-all duration-300"
                        >
                            <p>Ver Más</p>
