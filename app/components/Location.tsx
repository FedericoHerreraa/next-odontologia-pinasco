...
export const Location = () => {
    return (
        <div id="location" className="min-h-[100vh] mt-40">
            ...
            <h2 className={`md:text-6xl text-4xl text-zinc-700 text-center ${bebas.className}`}>Descubre Nuestra <span className="bg-gradient-to-r to-[#00a2af] from-[#46bcc9] bg-clip-text text-transparent">Ubicación.</span></h2>
