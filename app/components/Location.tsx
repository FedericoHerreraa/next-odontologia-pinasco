...
export const Location = () => {
    return (
        <div id="location" className="h-[100vh] mt-40">
            ...
            <section className="mt-20 flex justify-center items-center gap-20 w-[80%] mx-auto">
                <div className="w-1/2">
                    <h2 className={`text-3xl mb-4 ${bebas.className} text-zinc-700`}>Posicion Estrategica.</h2>
                ...
                <iframe 
                    ...
                    width="600" 
                    height="450" 
                    className="w-1/2 rounded-md shadow-xl"
                    loading="lazy">
                </iframe>
            </section>
        </div>
