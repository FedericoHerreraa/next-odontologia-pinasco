...
export const PreviewContact = () => {
    return (
        <div className="w-[80%] shadow-lg mx-auto my-60 bg-zinc-100  px-10 py-6 rounded-xl min-h-44 flex md:flex-row flex-col items-center md:justify-between md:gap-0 gap-10">
            <div>
