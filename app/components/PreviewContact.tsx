...
export const PreviewContact = () => {
    return (
        <div className="w-[80%] shadow-lg mx-auto my-60 bg-gradient-to-r to-white via-zinc-100 from-[#46bcc9] px-10 py-6 rounded-xl h-44 flex items-center justify-between">
            <div>
